...
RUN adduser --system --home /home/jvictormacedo  jvictormacedo
USER jvictormacedo

# Definindo o diretório onde a aplicação será armazenada
WORKDIR /home/jvictormacedo

# Definindo o local onde o binário do gunicorn é instalado
ENV PATH="/home/jvictormacedo/.local/bin:${PATH}"

# Copiar os arquivos da pasta local para dentro do container
COPY --chown=jvictormacedo:nogroup --chmod=444 app.py requirements.txt /home/jvictormacedo/
